...
object RevokeCommandSpecs {
    ...
    val entries: List<Entry> = listOf(
        ...
        Entry("UN_WARN", "ab.${PunishmentType.WARNING.getName()}.undo", "[0-9]+|(?i:clear \\S+)", "Un" + PunishmentType.WARNING.getConfSection("Usage"), listOf("unwarn")),
        Entry("UN_NOTE", "ab.${PunishmentType.NOTE.getName()}.undo", "[0-9]+|(?i:clear \\S+)", "Un" + PunishmentType.NOTE.getConfSection("Usage"), listOf("unnote")),
